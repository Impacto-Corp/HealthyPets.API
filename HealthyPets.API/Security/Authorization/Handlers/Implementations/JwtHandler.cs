...
namespace HealthyPets.API.Security.Authorization.Handlers.Implementations;

public class JwtHandler:IJwtHandler
{
    private readonly AppsSettings _appsSettings;

    public JwtHandler(IOptions<AppsSettings> appsSettings)
    {
    ...
    public string GenerateToken(User user)
    {
        ...
        Console.WriteLine($"Secret:{_appsSettings.Secret}");
        var secret = _appsSettings.Secret;
